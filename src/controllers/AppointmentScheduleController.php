...
class AppointmentScheduleController extends MyIwayController
{
    ...
    */
    ...
    /**
    * Lists all AppointmentSchedule models.
    * @return mixed
    */
    ...
    /**
    * Displays a single AppointmentSchedule model.
    * @param integer $id
    * @return mixed
    ...
    */
    ...
    /**
    * Creates a new AppointmentSchedule model.
    ...
    */
    ...
    /**
    * Updates an existing AppointmentSchedule model.
    ...
    */
    ...
    /**
    * Deletes an existing AppointmentSchedule model.
    ...
    */
    ...
    /**
    * Finds the AppointmentSchedule model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param integer $id
    * @return AppointmentSchedule the loaded model
    * @throws NotFoundHttpException if the model cannot be found
    */
    ...
    {
        if (($model = AppointmentSchedule::findOne($id)) !== null) {
            return $model;
        }
